...
class Signup extends Component{
    constructor(props){
        ...
        this.state = {
            first_name:'nadeem',
            last_name:'sajid',
            email: 'nadeem.sajissdd@gmail.com',
            password: '123456',
                ...
                <MuiThemeProvider >
                    <div>
                        ...
                        <TextField
                            ...
                            onChange={(event, newValue) => this.setState({ confirm_password: event.target.value })}
                        />
                        <br />
                        <TextField
                            type="text"
                            ...
                            onChange={(event, newValue) => this.setState({ user_role: event.target.value })}
                        />
                        <br />
                        <br />
                        <br />
                        <br />
                            <div onClick = { () => this.props.history.push('login') }>
                                <label className="forgot_password">Already have an account ?</label>
                            </div>
                            <br />
                        <RaisedButton
                            label=""
                        ...
                        >
                            {loading ? <CircularProgress size = {20} /> : <label className="formDiv_button">Signup</label>}
                        </RaisedButton>
